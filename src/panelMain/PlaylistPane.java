 ...
 */
public class PlaylistPane extends javax.swing.JPanel {
    ...
    public PlaylistPane() {
        initComponents();
        c = (CardLayout) pnlContent.getLayout();
        pnlContent.setLayout(c);
        c.first(pnlContent);
    }
    ...
    private void initComponents() {
        ...
        pnlMyPlaylist = new swing.PlaylistPanel();
        pnlPlaylistLove = new swing.PlaylistPanel();
        ...
        pnlMyPlaylist.setMinimumSize(new java.awt.Dimension(1284, 510));
        pnlMyPlaylist.setPreferredSize(new java.awt.Dimension(1284, 510));
        pnlContent.add(pnlMyPlaylist, "myPlaylist");

        pnlPlaylistLove.setMinimumSize(new java.awt.Dimension(1284, 510));
        pnlPlaylistLove.setPreferredSize(new java.awt.Dimension(1284, 510));
        pnlContent.add(pnlPlaylistLove, "playlistLove");
    ...
    private swing.PlaylistPanel pnlMyPlaylist;
    private swing.PlaylistPanel pnlPlaylistLove;
